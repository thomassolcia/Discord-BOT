exports.run = async (client, message, args) => {
    ...
    if(parseFloat(upbotfix).toFixed(2) < 2){
        message.reply('Espancando maconheiros tem ' + parseFloat(upbotfix).toFixed(2) + ' hora!');
    }else if(parseFloat(upbotfix).toFixed(2) <= 23.999999998 && parseFloat(upbotfix).toFixed >= 2) {
        message.reply('Espancando maconheiros tem ' + parseFloat(upbotfix).toFixed(2) + ' horas!');
