...
exports.run = async (client, message, args) => {
    ...
    if (!args[0]) {
        const embed = new Discord.MessageEmbed()
            .setColor('BLACK')
            .setTimestamp()
            .setFooter(`Comando =top global`, `https://cdn.discordapp.com/avatars/704392967074349087/9956009aae6e58b3e4c0ef086e98ad9b.png`)
        ...
        const embed = new Discord.MessageEmbed()
            .setColor('BLACK')
            .setTimestamp()
            .setFooter(`Comando =top daily`, `https://cdn.discordapp.com/avatars/704392967074349087/9956009aae6e58b3e4c0ef086e98ad9b.png`)
            .setThumbnail(message.author.avatarURL({ dynamic: true }))
        ...
        const embed = new Discord.MessageEmbed()
            .setColor('BLACK')
            .setTimestamp()
            .setFooter(`Comando =top weekly`, `https://cdn.discordapp.com/avatars/704392967074349087/9956009aae6e58b3e4c0ef086e98ad9b.png`)
            .setThumbnail(message.author.avatarURL({ dynamic: true }))
